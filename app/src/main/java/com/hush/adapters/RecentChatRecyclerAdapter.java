        ...
        FirebaseUtil.getOtherUserFromChatroom(model.getUserIds())
                .get().addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        ...
                        if (otherUserModel != null && otherUserModel.getProfileImage() != null) {
                            holder.profilePic.setImageBitmap(ImageUtil.getBitmapImage(otherUserModel.getProfileImage()));
                        }
